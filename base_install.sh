# This is the base install script, inspired by the Debian-titus project.
...
sudo apt install feh bspwm sxhkd kitty rofi python3-pip thunar lxpolkit x11-xserver-utils unzip yad wget pulseaudio pavucontrol -y
echo "Installing optional programs..."
sudo apt install neofetch lxappearance papirus-icon-theme fonts-noto-color-emoji sddm fonts-font-awesome -y



echo "Installing theme (Nordic-darker-v40)"
